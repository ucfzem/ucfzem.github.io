      ...
      messages: [
        {
          ...
          content:
            ...
            '\n6. ❌ لا تستبدل الكلمات بمرادفاتها — "أعوام" تبقى "أَعْوَام" (وليس سِنِين) | "قال" تبقى "قَال" (وليس ذَكَر)' +
            '\n7. ✅ الشدة (ّ) واجبة على الحروف المضعّفة' +
      ...
      messages: [
        {
          ...
          content:
            ...
            '\n6. ❌ لا تستبدل الكلمات بمرادفاتها — "أعوام" تبقى "أَعْوَام" (وليس سِنِين) | "قال" تبقى "قَال" (وليس ذَكَر)' +
            '\n7. ✅ الشدة (ّ) واجبة على الحروف المضعّفة' +
            '\n\n【اسم الفاعل】وزن "مُفْعِل": أَشْمَسَ → مُشْمِس (وليس مُشَمَّس) | أَقْمَرَ → مُقْمِر (وليس مُقَمَّر)' +
            '\n【فَعِيلَة vs فُعُول】ظهيرة ← ظَهِيرَة (وليس ظُهُور) — الحرف الثالث ياء يحدد الوزن' +
            ...
            '\n【الإعراب】الرفع بالضمة: الْكِتَابُ | النصب بالفتحة: الْكِتَابَ | الجر بالكسرة: الْكِتَابِ' +
            '\n\nقاعدة ذهبية: الحروف الأصلية أمانة. التشكيل فقط ما يُضاف.' +
            '\nأعد فقط النص المشكول كاملاً بدون أي شرح.' +
            '\n\n' + FEW_SHOT_EXAMPLES,
        },
